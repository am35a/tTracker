...
<footer>
    ...
    <!-- svelte-ignore a11y-click-events-have-key-events -->
    <div on:click={() => $user.page.current = 3}>
        <svg
            class={$user.page.current === 3 ? 'active' : ''}
            xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 16 16">
    ...
    <!-- svelte-ignore a11y-click-events-have-key-events -->
    <div on:click={() => $user.page.current = 4}>
        <svg
            class={$user.page.current === 4 ? 'active' : ''}
            xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 16 16">
